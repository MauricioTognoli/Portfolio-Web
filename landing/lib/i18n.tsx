...
export const translations: Record<Lang, Translations> = {
  es: {
    ...
    features: {
      ...
      desc: "Soluciones que diseñé y desarrollé para resolver problemas reales de producto.",
      viewAll: "Ver todas las features →",
      cta: "Ver features →",
      pageTitle1: "Features que construyo,",
      pageTitle2: "problemas que resuelven.",
      pageSubtitle:
        "Cada feature que ves acá nace de un problema real de producto. Son soluciones que diseñé y desarrollé para construir interfaces modernas, claras y orientadas a las necesidades reales de los usuarios.",
      hint: "Implementaciones y demos interactivas",
      problemLabel: "El problema",
      solutionLabel: "Mi solución",
      summaryTitle: "Código real, soluciones reales.",
      summaryDesc:
        "¿Tenés un producto que necesita una mejor experiencia de usuario? Puedo ayudarte a convertir ideas y problemas de negocio en interfaces modernas, rápidas y bien construidas. Hablemos de lo que estás buscando construir.",
    ...
    projects: {
      ...
      moreSub: "SaaS · Landing corporativa · Design Systems",
    },
    mtc: {
      label: "Open Source",
    ...
    sticky: { text: "Abierto a propuestas", btn: "Datos rápidos →" },
    footer: {
  ...
  en: {
    ...
    features: {
      ...
      desc: "Solutions I designed and built to solve real product problems.",
      viewAll: "View all features →",
      cta: "View features →",
      pageTitle1: "Features I build,",
      pageTitle2: "problems they solve.",
      pageSubtitle:
        "Every feature you see here comes from a real product problem. These are solutions I designed and built to create modern, clear interfaces focused on real user needs.",
      hint: "Production implementations & interactive demos",
      problemLabel: "The problem",
      solutionLabel: "My solution",
      summaryTitle: "Real code, real solutions.",
      summaryDesc:
        "Does your product need a better user experience? I can help turn your ideas and business challenges into modern, fast, and well-crafted interfaces. Let’s talk about what you’re looking to build.",
    ...
    projects: {
      ...
      moreSub: "SaaS · Corporate landing · Design Systems",
    },
    mtc: {
      label: "Open Source",
      title1: "Mauricio Tognoli",
    ...
    sticky: { text: "Open to offers", btn: "Quick facts →" },
    footer: {
      tagline: "Frontend Engineer.",
      cv: "Resume",
      components: "Components",
